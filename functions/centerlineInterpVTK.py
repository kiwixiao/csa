#/usr/bin/env python3
#!/home/batfk5/Programs/anaconda3/bin/python3


#import sys
#sys.path.append("/home/batfk5/Programs/anaconda3/lib/python3.6/site-packages")
import argparse
import csv
import numpy as np
import os
...
from vtk import vtkSTLReader, vtkSTLWriter, vtkPoints, vtkPolyData, vtkUnstructuredGrid,vtkXMLPolyDataReader, vtkUnstructuredGridWriter, vtkXMLPolyDataWriter, vtkPolyDataReader, vtkPolyDataWriter
...
# def voxel_indices(target: sitk.Image) -> np.ndarray:
#    """Image voxel indices."""
#    return np.stack(
#        np.meshgrid(*[np.arange(n) for n in target.GetSize()], indexing="ij"), axis=-1
#    )
...
if __name__ == "__main__":
    ...
    if args.output_table:
        ...
        table.to_csv(args.output_table)
